...
- When done, briefly confirm: what was added/changed (including test files), and the Linear issue id (e.g. SYT-17) so the user can move it to In Progress or link a PR.
